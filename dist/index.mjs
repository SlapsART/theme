...
var baseTheme = createTheme(baseThemeConfig);
...
var themeCosmosLight = createTheme2(mergedConfig);
var themeCosmosLight_default = themeCosmosLight;

// src/themeCosmosDark.ts
import { createTheme as createTheme3 } from "@mui/material/styles";
...
var themeCosmosDark = createTheme3(mergedConfig2);
var themeCosmosDark_default = themeCosmosDark;

// src/index.ts
import { createTheme as createTheme4 } from "@mui/material/styles";
export {
  baseTheme_default as baseTheme,
  createTheme4 as createTheme,
  themeCosmosDark_default as themeCosmosDark,
  themeCosmosLight_default as themeCosmosLight
};
